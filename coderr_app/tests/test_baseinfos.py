...
class BaseInfoTests(APITestCase):
    ...
    def test_get_base_info_as_admin(self):
    ...
    def test_get_base_info_as_business(self):
        url = reverse('base-info')
    ...
    def test_get_base_info_as_customer(self):
        url = reverse('base-info')
    ...
    def test_get_base_info_as_unauthorized(self):
        url = reverse('base-info')
